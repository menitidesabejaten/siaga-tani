document.addEventListener("DOMContentLoaded", () => {
    ...
    dropdowns.forEach(dropdown => {
        dropdown.addEventListener("click", function(e) {
            // Perbaikan nilai threshold menjadi 850px agar sesuai dengan layout yang baru
...
document.addEventListener("DOMContentLoaded", function() {
    function applyBlocker() {
        ...
        const isSmallWindow = window.innerWidth <= 850;
        
        // Ketika pengguna mengakses situs dengan "Mode Desktop" di HP,
        // ukuran view dan userAgent akan menyesuaikan sehingga situs tidak lagi diblokir.
